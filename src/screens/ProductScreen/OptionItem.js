...
const OptionItem = ({
  ...
  const {name: selectedModifierName, cost: selectedModifierCost} = selectedInnerModifier || {};
            ...
            options?.map((item, index) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityLabel={getInnerCost({name: item.name, cost: item.cost})}
                  ...
                  <RText
                    accessible={false}
                    text={getInnerCost({name: item.name, cost: item.cost})}
                    size={'xxs'}
                    numberOfLines={3}
